...
export default function AiAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "model",
      parts: [{ text: "Ayubowan! 🌸 I am your **Visit Sri Lanka Guide AI Assistant**. I can help you plan your itinerary, explain local transport, convert currency, look up hiking paths, suggest restaurants, or review Sri Lankan historical facts. What's on your travel mind?" }]
    }
  ]);
