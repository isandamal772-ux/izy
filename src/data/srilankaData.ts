...
export const HOTELS_DATA: Hotel[] = [
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/KRezxB3pr5A/download?force=true",
    rating: 4.7,
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/Ukj7OWt-aZs/download?force=true",
    rating: 4.9,
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/lLT8jXU0mx0/download?force=true",
    rating: 5.0,
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/duczwUYD2zE/download?force=true",
    rating: 4.8,
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/srZtj-Iq7dw/download?force=true",
    rating: 4.7,
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/afum06KZ9hE/download?force=true",
    rating: 4.5,
  ...
  },
  {
    ...
    imageUrl: "https://unsplash.com/photos/KzlIoHWFjKA/download?force=true",
    rating: 4.8,
...
export const BLOGS_DATA = [
  {
    id: "bl-beaches",
    title: "Top 10 Most Stunning Beaches in Sri Lanka",
    excerpt: "From the surfing point-breaks of Arugam Bay to the shallow natural pools of Talpe, find out which beaches should be on your itinerary.",
    content: "Sri Lanka is a tropical island with over 1,300km of continuous white coastline. We review the ten absolute best beaches for swimming, surfing, marine wildlife, and luxury resorts. Highlights include Mirissa's Coconut Tree Hill, Nilaveli's crystalline Pigeon Island marine coral trails, Hiriketiya's cool surf camps, and the shallow pools of Talpe...",
  ...
  {
    id: "bl-waterfalls",
    title: "The Ultimate Guide to Sri Lanka's 10 Best Waterfalls",
    excerpt: "How to hike to the tallest, swim in secret mountain pools, and admire the majestic tea landscape cascades of the central highlands.",
    content: "The hill country is one of the wettest mountain biomes in Southeast Asia, creating hundreds of dramatic cascades. We catalog the 10 tallest and most beautiful waterfalls, complete with coordinates, hiking guides, and optimal seasons. Learn how to swim in Upper Diyaluma's infinity pools, photograph Devon Falls from tea fields, and check out the towering heights of Bambarakanda...",
  ...
  {
    id: "bl-couples",
    title: "Best Places to Visit in Sri Lanka for Couples & Honeymooners",
    excerpt: "Deep romantic tea estates, isolated beaches, and breathtaking sunset cliffs perfect for a dream romantic escape.",
    content: "If you are celebrating a wedding or planning a romantic trip to Sri Lanka, we have mapped out the ultimate destinations. From the mist-covered organic cabins of 98 Acres Resorts in Ella to the wild beach retreats of Tangalle, Sri Lanka presents stunning intimate retreats. Spend your afternoon dining in colonial Hatton bungalows and walking along Galle Fort's historic bastions...",
    author: "Sarah & David",
    date: "May 2026",
  ...
  {
    id: "bl-budget",
    title: "The Backpacker's Budget Guide to Travelling Sri Lanka",
    excerpt: "How to survive on $25 a day, travel on the iconic blue trains, eat delicious local street foods, and find free hiking spots.",
    content: "Travelling on a budget in Sri Lanka is incredibly rewarding since local trains, street rotis, and public beaches are remarkably cheap. Our guide breaks down food costs, hostel listings, and travel passes. Discover how to ride the world-famous Kandy-to-Ella train for less than $2, eat delicious curries for $1.50, and bag the ultimate scenic peaks without spending a penny...",
  ...
  {
    id: "bl-luxury",
    title: "Ultra-Luxury Sri Lanka: Resorts, Private Jets & Curated Safaris",
    excerpt: "A look into the finest five-star experiences, private helicopters, and high-end boutique properties on the paradise island.",
    content: "For discerning travelers looking for ultra-exclusive premium vacations, Sri Lanka delivers unmatched quality. We explore high-end Resplendent Ceylon tea bungalows, the private plunge pool huts of Chena Huts in Yala, and private yacht charters in Mirissa. Witness wildlife accompanied by professional biologists and navigate the island using executive air charters...",
